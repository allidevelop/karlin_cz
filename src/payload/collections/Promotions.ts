...
export const Promotions: CollectionConfig = {
  ...
  fields: [
    { name: 'title', type: 'text', required: true, localized: true, label: 'Název akce' },
    { name: 'slug', type: 'text', required: true, unique: true },
    { name: 'description', type: 'textarea', localized: true, label: 'Popis' },
    ...
    { name: 'badge', type: 'text', localized: true, label: 'Štítek (např. -20%)' },
