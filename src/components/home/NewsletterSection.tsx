        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
          ...
          <div className="flex-1 backdrop-blur-[2px] bg-white/10 border border-white/10 rounded-[10px] p-6 lg:p-[25px] flex flex-col justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-[#f0eff0] text-[#302e2f] font-clash font-medium text-[14.9px] leading-[24px] rounded-[10px] px-8 py-4 hover:opacity-90 transition-opacity w-full lg:w-auto"
            >
